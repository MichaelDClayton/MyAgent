...
function App() {
  const [messages, setMessages] = useState<Message[]>([
    { text: "Welcome to your Concierge. How can I help with your booking?", isBot: true }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const { reply, timestamp } = response.data;
      // Format the ISO string to local time (e.g., "12:05 PM")
